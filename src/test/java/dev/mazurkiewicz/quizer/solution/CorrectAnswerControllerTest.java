...
//
//@WebMvcTest(CorrectAnswerController.class)
...
//        CorrectAnwserCheckRequest request = new CorrectAnwserCheckRequest(1, AnswerType.C);
...
//        when(service.checkSingleAnswer(any(CorrectAnwserCheckRequest.class))).thenReturn(new SolutionResponse(0, 1, Map.of(1L, AnswerType.B)));
//
//        mvc.perform(post("/api/v3/solutions/single")
//                .contentType(MediaType.APPLICATION_JSON)
...
//        CorrectAnwserCheckRequest request = new CorrectAnwserCheckRequest(11, AnswerType.C);
