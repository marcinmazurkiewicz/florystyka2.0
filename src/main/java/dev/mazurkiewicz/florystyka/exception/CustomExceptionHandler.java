...
public class CustomExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler({BadCredentialsException.class, UnauthorizedAccessException.class, TokenExpiredException.class})
    public ErrorResponse handleBadCredentialsException(Exception ex, WebRequest request) {
        return mapToErrorResponse(ex, HttpStatus.UNAUTHORIZED, request);
    }

    @ResponseStatus(HttpStatus.FORBIDDEN)
    @ExceptionHandler(ForbiddenAccessException.class)
    public ErrorResponse handleForbiddenAccessException(Exception ex, WebRequest request) {
        return mapToErrorResponse(ex, HttpStatus.FORBIDDEN, request);
    }
