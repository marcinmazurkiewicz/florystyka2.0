...
//
//import io.dudek.florystyka.domain.AnswerType;
...
//        return DriverManager.getConnection("jdbc:mysql://" + DBData.get("address") + "?" + DBData.get("options"), DBData.get("username"), DBData.get("password"));
//
//    }
//
...
//
//
//    public List<Question> generateQuestionsList(Set<Integer> ids) {
//        List<Question> result = new ArrayList<>();
//        Connection connection = null;
//        try {
//            connection = getConnection();
