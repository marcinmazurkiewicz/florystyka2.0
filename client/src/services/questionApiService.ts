...
export async function checkAndSaveTest(answers: SolutionRequest[]): Promise<PreparedResponse<TestSolutionResponse>>  {
    return postRequest<TestSolutionResponse>(
        "/api/v3/logged/solutions/test",
        answers,
        true
    );
}
