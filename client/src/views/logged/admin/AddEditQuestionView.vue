  ...
  <div class="mb-4 w-full h-full max-w-screen-lg mx-auto box-border lg:px-4 xl:px-10">
    <div class=" w-full table p-4 box-border lg:my-10 xl:p-8">
      ...
      <section class="border p-6 rounded-xl my-4 border-light-gray">
        ...
        <text-area-input type="textarea" v-model="question.content" id="content" :error="errors['content']">Treść
          pytania
        </text-area-input>
      ...
      <section class="border p-6 rounded-xl my-4" :class="isCorrect('A') ? 'border-light-green' : 'border-light-gray'">
        <text-input v-model="question.answerA" id="answerA" :error="errors['answerA']">Odpowiedź A</text-input>
        <switch-radio value="A" id="correctA" name='correct'
                      v-model="question.correct" :error="errors['correct']">
      ...
      <section class="border p-6 rounded-xl my-4" :class="isCorrect('B') ? 'border-light-green' : 'border-light-gray'">
        <text-input v-model="question.answerB" id="answerB" :error="errors['answerB']">Odpowiedź B</text-input>
      ...
      <section class="border p-6 rounded-xl my-4"
        ...
        <text-input v-model="question.answerC" id="answerC" :error="errors['answerC']">Odpowiedź C</text-input>
      ...
      <section class="border p-6 rounded-xl my-4"
        ...
        <text-input v-model="question.answerD" id="answerD" :error="errors['answerD']">Odpowiedź D</text-input>
      ...
      <section class="border p-6 rounded-xl my-4 border-light-gray">
        ...
        <text-input v-model="question.year" type="number" id="year" :error="errors['year']" min="2000">Rok egzaminu
        </text-input>
        <text-input v-model="question.month" type="number" id="month" :error="errors['month']" min="1" max="12">Miesiąc
          egzaminu
        </text-input>
      </section>
